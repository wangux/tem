...
import VueRouter, { Route, RouteRecord, RouteConfig , RawLocation } from 'vue-router'
...
export default class extends Vue {
  ...
  private closeOthersTags() {
    this.$router.push(this.selectedTag as RawLocation);
  ...
  private toLastView(visitedViews: ITagView[], view: ITagView) {
    ...
    if (latestView) {
      this.$router.push(latestView as RawLocation)
    } else {
