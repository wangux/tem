...
import Layout from '@/layoutnew/index.vue'
...
export const constantRoutes: RouteConfig[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import(/* webpackChunkName: "dashboard" */ '@/views/main/index.vue'),
        name: 'index',
        meta: {
          title: 'main',
          icon: 'home',
  ...
  },
  {
    path: '/dataSelect',
    component: Layout,
    redirect: '/dataSelect/index',
    children: [
      {
        path: 'index',
        component: () => import(/* webpackChunkName: "dashboard" */ '@/views/dataSelect/index.vue'),
        redirect: '/dataSelect/index/realtimeData',
        name: 'dataSelect',
        meta: {
          title: 'dataSelect',
          icon: 'home',
        ...
        children: [
          {
            path: 'realtimeData',
            component: () => import('@/views/dataSelect/components/realTime-data.vue'),
            name: 'realtimeData',
            meta: {
              title: 'realtimeData'
            }
          ...
          {
            path: 'historyData',
            component: () => import('@/views/dataSelect/components/history-data.vue'),
            name: 'historyData',
            meta: {
              title: 'historyData'
            }
